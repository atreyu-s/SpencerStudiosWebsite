...
const projects = [
  ...
  },
  {
    ...
    description: [
      ...
      'The project is being developed in close collaboration with Billy Cavalieri, a seasoned strength and conditioning coach, to ensure the tool reflects how serious athletes and coaches actually think about training data.',
    ],
    partner: {
